    ...
    for(unsigned int p=0; p<3; p++) {
        ...
        for(unsigned int i=0; i<n-1; i++) {
            ...
            if(i<n-2) {
                ...
                M  (4*i + 2, c) = 1;  // 2nd derivative at first knot = 0
            }
        ...
        M(4*(n-1)-2, 4*(n-2) + 0) += M(4*(n-1)-3, 4*(n-2) + 0);
        M(4*(n-1)-2, 4*(n-2) + 1) += M(4*(n-1)-3, 4*(n-2) + 1);
        M(4*(n-1)-2, 4*(n-2) + 2) += M(4*(n-1)-3, 4*(n-2) + 2);
        M(4*(n-1)-2, 4*(n-2) + 3) += M(4*(n-1)-3, 4*(n-2) + 3);
